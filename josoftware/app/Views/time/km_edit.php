...
<div class="flex justify-between items-center mb-2">
    <h2 style="font-size:1.1rem;font-weight:700;">Kilometers bewerken</h2>
    <a href="<?= APP_URL ?>/kilometers" class="btn btn-secondary btn-sm">&#8592; Terug</a>
</div>

<div class="card">
    <div class="card-body">
        <form method="POST" action="<?= APP_URL ?>/kilometers/<?= (int)$entry['id'] ?>/edit" id="km-form">
            <?= CSRF::field() ?>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="from_location"
                        class="form-input"
                        value="<?= htmlspecialchars($entry['from_location'], ENT_QUOTES, 'UTF-8') ?>"
                        maxlength="200"
                        required
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="to_location"
                        class="form-input"
                        value="<?= htmlspecialchars($entry['to_location'], ENT_QUOTES, 'UTF-8') ?>"
                        maxlength="200"
                        required
                    >
                </div>
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="purpose"
                    class="form-input"
                    value="<?= htmlspecialchars($entry['purpose'], ENT_QUOTES, 'UTF-8') ?>"
                    maxlength="300"
                    required
                >
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input
                        ...
                        step="0.1"
                        min="0.1"
                        value="<?= htmlspecialchars(number_format((float)$entry['km'], 1, '.', ''), ENT_QUOTES, 'UTF-8') ?>"
                        required
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        step="0.001"
                        min="0"
                        value="<?= htmlspecialchars(number_format((float)$entry['rate_per_km'], 3, '.', ''), ENT_QUOTES, 'UTF-8') ?>"
                        readonly
                    >
                </div>
            </div>
